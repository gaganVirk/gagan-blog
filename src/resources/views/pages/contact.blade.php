...
<div class="flex flex-wrap justify-center">
  <form class="w-full max-w-lg pt-5" action="/send-email" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="px-4 pr-8 mb-6 md:mb-0">
      ...
      <div class="px-4">
        ...
        <button class="px-4 text-xl border mt-8 p-8 font-semibold text-xl" type="button">
          Send
        </button>
        </div>
  </form>
