    ...
    <div class="flex md:flex-row-reverse flex-wrap">
        <div class="w-full md:w-3/4 bg-white-500 p-4 text-center text-gray-700">
            <h3>Latest posts</h3>
            
                <img src="/images/gagan.png" alt="Gagan"/>

        </div>
        <div class="w-full md:w-1/4 bg-white-500 p-4 text-center text-gray-700">
